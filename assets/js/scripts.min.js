...
!function(o,e,a){o("#menu").click(function(){o("body").addClass("push-menu-to-right"),o("#sidebar").addClass("open"),o(".overlay").addClass("show")}),o("#mask").click(function(){o("body").removeClass("push-menu-to-right"),o("#sidebar").removeClass("open"),o(".overlay").removeClass("show")});var s=!1;o(e).scroll(function(){s||(e.requestAnimationFrame(function(){0<o(e).scrollTop()?o("body").addClass("light"):o("body").removeClass("light"),s=!1}),s=!0)});var c=o(".modal .close");c.on("click",function(){c.parent().parent().addClass("closed")});var n=o(".modal.exit");n.length&&ouibounce(n[0],{aggressive:!0,callback:function(){n.find(".close").on("click",function(){n.hide()})}});var l={close:o(".icon-remove-sign"),searchform:o(".search-form"),canvas:o("body"),dothis:o(".dosearch")};function r(){o(".search-wrapper").toggleClass("active"),l.searchform.toggleClass("active"),l.canvas.removeClass("search-overlay")}l.dothis.on("click",function(){o(".search-wrapper").toggleClass("active"),l.searchform.toggleClass("active"),l.searchform.find("input").focus(),l.canvas.toggleClass("search-overlay"),o(".search-field").simpleJekyllSearch()}),l.close.on("click",r),document.addEventListener("keyup",function(e){27==e.keyCode&&o(".search-overlay").length&&r()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
